    ...
    def run(self):
        try:
	      ...
	      self.serial_port.close()
            self.serial_port = serial.Serial(**self.serial_arg)#(port='/dev/pts/4', baudrate=57600, bytesize=8 , stopbits=1, parity='N', timeout=0.01 ) # **self.serial_arg)
        ...
        while self.alive.isSet():
            ...
            if len(data) > 0:
                ...
                self.data_q.put(data) #((data, timestamp))
